...
input_data = {
    ...
    'curses': ['stupid', 'idiot', 'dumb'],
}

output_data = {
    'answers': ['i\'m okay', 'i\'m fine', 'just fine', 'grate', 'you know, life...'],
...
info_commands = {
    ...
    'delete_all_data': 'Deletes all the data from user inputs',
    'clear_all_data': 'Deletes all the data from user inputs',
}
